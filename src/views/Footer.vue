    ...
    <div class="w-[90%] md:w-full lg:w-[1420px] xl:w-[1420px]">
      <div class="py-4 lg:mt-0 xl:mt-0 mt-12">
        ...
        >
          ...
          elit. Odio euismod lacinia at quis. Sit amet commodo nulla facilisi
          nullam vehicula ipsum a arcu.
        </p>
      </div>

      <div
        class="w-[70%] mx-auto lg:w-[1420px] xl:w-[1420px] h-[2px] rounded-lg bg-lebeltext mt-8"
      ></div>
      <div
      ...
      <div
        class="w-full max-w-[1420px] lg:flex xl:flex hidden md:hidden items-center justify-between mt-12"
      >
        <div class="w-[400px]">
          <img
