              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <p class="inline">
                        Web development refers to the process of building,
                  ...
                  <tr class="odd:bg-white even:dark:bg-primery1/5">
                    ...
                    <td
                      class="px-6 py-4 text-textbody border-2 border-borderBody"
                    >
                      System development refers to the process of creating,
                      designing, implementing, and maintaining software systems
                      to meet specific business or organizational needs.
                    </td>
                    <td
                      class="px-6 py-4 border-b-2 border-r-2 border-t-2 border-borderBody space-x-2 p-2"
                    >
