                ...
                >
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        src="https://i.pinimg.com/736x/f3/36/16/f33616c86962253df860f171e4b556f0.jpg"
                        alt=""
                      />
                    </td>
                    <td
                      class="px-6 py-4 text-textbody border-2 border-borderBody"
                    >
                      A mobile POS can help you bust lines, showcase more items
                      to shoppers, and help your staff recall product details on
                      the sales floor
                    </td>

                    <td
                      class="px-6 py-4 border-b-2 border-r-2 border-t-2 border-borderBody space-x-2"
                    >
                      <div
                      ...
                      >
                        ...
                        <button
                          class="w-[36px] flex items-center justify-center h-[36px] bg-[#393CD8BF]/75 rounded-[6px]"
                        >
                          <font-awesome-icon
                            icon="bullhorn"
                  ...
                  <tr class="odd:bg-white even:dark:bg-primery1/5">
                    ...
                    <td
                      class="px-6 py-4 text-textbody border-2 border-borderBody"
                    >
                      Coloshop is a free Bootstrap eCommerce website template
                      with the modern and smart layout. To sell products online,
                      this template will help you create a website that’s
                      responsive as well as user-friendly.
                    </td>
